...
function lf_geturlstart(){
	try {
		var all_panabitvalue = new Object(); 
		all_panabitvalue = geturl_request();

		mac=all_panabitvalue['clientmac'].replace(/-/g,":");
		user_ip=all_panabitvalue['clientip'];
		basip=all_panabitvalue['paip'];
		refer="http://"+all_panabitvalue['iarmdst'];
